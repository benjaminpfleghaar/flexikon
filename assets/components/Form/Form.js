	...
	form.innerHTML = `
		...
		<form aria-labelledby="title" data-js="form">
			<fieldset class="form__fieldset" aria-describedby="description-question">
				...
				<p class="form__fieldset-description" id="description-question">Enter the question and some keywords</p>
			...
			<footer class="form__footer">
				<button type="button" class="form__button form__button--outlined" aria-label="Reset the form" data-js="reset-button">Reset</button>
				<button type="submit" class="form__button" aria-label="Save the new question" data-js="submit-button">Save question</button>
			</footer>
		</form>
	`;
